    ...
    <div className="sm:py-7 py-4 flex items-center lg:h-[100px] sm:h-20 bg-rich-black">
      <div className="container">
        <div className="flex justify-between items-center lg:h-[100px] sm:h-20">
          <a href="/">
            <img className='lg:max-w-[192px] max-w-[120px]' src="/assets/images/webp/header-logo.webp" alt="header-logo" />
          </a>
          ...
          <div
            onClick={toggleMenu}
            className='menuIcon relative max-sm:w-[30px] max-sm:h-[24px] max-lg:w-[38px] max-lg:h-[28px] z-30 max-lg:flex max-lg:justify-between max-lg:flex-col max-lg:cursor-pointer transition ease-linear duration-300 lg:hidden'
          >
            {isMenuOpen ? (
              <>
          ...
          <div className={`menuList ${isMenuOpen ? 'max-lg:left-0' : 'max-lg:left-[-100%]'} z-20 gap-8 max-lg:w-full max-lg:fixed max-lg:justify-center max-lg:top-0 max-lg:bg-black max-lg:flex-col max-lg:transition-all duration-300 flex items-center max-lg:min-h-screen`}>
