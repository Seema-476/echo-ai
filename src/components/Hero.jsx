...
const Hero = () => {
  return (
    <div className='bg-hero-bg bg-cover lg:bg-[100% 100%] bg-no-repeat bg-center lg:h-[840.23px] relative' id='about'>
      <Header/>
      <div className='container relative'>
        <div className='flex lg:flex-row flex-col gap-5 max-xl:pt-12'>
          ...
          <div className='absolute right-[-57px] top-[60px] xl:block hidden'>
            <img className='max-w-[470px] h-[559px] w-full pointer-events-none' src="/assets/images/webp/hero-main-image.webp" alt="hero-image" />
          </div>
          <div className='xl:hidden flex justify-center'>
            <img className='w-full max-w-[470px] pointer-events-none' src="/assets/images/webp/hero-main-image.webp" alt="hero" />
          </div>
        </div>
      </div>
